  ...
  async ({ event, step }) => {
    ...
    await sendEmail({
      ...
      body: `<div style="font-family: Arial, sans-serif; line-height: 1.5;">
        ...
        <p>Enjoy the show! 🍿</p>
        <p>Thanks for booking with us!<br />- MaiShow Team</P>
      </div>`,
    });
  }
);
  ...
  async ({ step }) => {
    ...
    const results = await step.run("send-all-reminders", async () => {
      return await Promise.allSettled(
        ...
        <br />
        <p>Enjoy the show! 🍿 - MaiShow Team</P>
      </div>`,
          })
        )
      );
  ...
  async ({ event }) => {
    ...
    for (const user of users) {
      ...
      const body = `<div style="font-family: Arial, sans-serif; padding: 20px;">
        ...
        <p>Visit our website - <a href="https://maishow-site.vercel.app/">MaiShow</a> 🔗</p>
        <br />
        <p>Thanks, <br />MaiShow Team</p>
      </div>`;
